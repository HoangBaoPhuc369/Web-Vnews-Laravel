                  ...
                  <div class="p-10 p-md-11 p-lg-13">
                    ...
                    <form method="POST" action="{{ route('login') }}" class="text-start mb-3">
                      ...
                      <div class="form-floating mb-4">
                        <input type="email" class="form-control" placeholder="Email" id="loginEmail" name="email"  :value="old('email')" required autofocus>
                        <label for="loginEmail">Email</label>
                      </div>
                      <div class="form-floating password-field mb-4">
                        <input type="password" class="form-control" placeholder="Password" id="loginPassword"  name="password" required autocomplete="current-password">
                        <span class="password-toggle"><i class="uil uil-eye"></i></span>
                        <label for="loginPassword">Password</label>
                      </div>
                      <button name="submit" type="submit" class="btn btn-primary rounded-pill btn-login w-100 mb-2">Sign Up</button>
                    </form>
                    <!-- /form -->
                    <p class="mb-1">
                        @if (Route::has('password.request'))
                            <a class="hover" href="{{ route('password.request') }}">
