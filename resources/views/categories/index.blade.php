  ...
  <div class="container py-14 py-md-16 text-center">
    <div class="row">
      <div class="col-md-10 offset-md-1 col-lg-8 offset-lg-2">
        <h2 class="fs-15 text-uppercase text-muted mb-3">All Categories</h2>
      </div>
      <!-- /column -->
    </div>
    <!-- /.row -->
      ...
      <div class="row gx-md-5 gy-5 text-center">
        ...
        <div class="col-md-6 col-xl-3">
          <div class="card shadow-lg">
            <div class="card-body">
              <h4><a  href="{{ route('categories.show', $category) }}">{{ $category->name }}</a></h4>
              <p class="mb-2"> {{ $category->created_at->diffForHumans() }}</p>
